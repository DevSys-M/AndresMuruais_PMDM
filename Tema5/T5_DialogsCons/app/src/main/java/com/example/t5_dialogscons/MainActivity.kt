...
class MainActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener,
    ...
    DialogoMultiple.OnMultipleListener,
    ...
    override fun usuarioSelected(usuario: Usuario) {
        ...
        DialogoConfirmacion.newInstance(hora, minutos, dia, mes, anio, nombre)
    ...
    override fun notaSelected(mensaje: String) {
        nota = mensaje
        DialogoPersoResumen.newInstance(hora, minutos, dia, mes, anio, nombre,apellido,asignaturas, nota)
            .show(supportFragmentManager, null)
